    ...
    <el-card>
      ...
      <el-row class="cat_opt">
        <el-col>
          <span>选择商品分类：</span>
          <!-- 选择商品分类的级联选择框 -->
          <el-cascader v-model="selectedCateKeys" :options="catelist" :props="cateProps" @change="handleChanged" clearable></el-cascader>
        </el-col>
      </el-row>
      <!-- tab标签页 -->
          ...
          <el-table :data="manyTableData" border stripe>
            ...
            <el-table-column type="expand">
              <template slot-scope="scope">
                <el-tag v-for="(item, i) in scope.row.attr_vals" :key="i" size="medium" closable @close="handleClose(i, scope.row)">
                  {{ item }}
                </el-tag>
                <!-- 可修改的添加Tag -->
                <el-input
...
export default {
  ...
  methods: {
    ...
    showInput(row) {
      ...
      // $nextTick方法的作用，当页面上元素重新渲染后，会指定回调函数中代码！！！
      this.$nextTick(_ => {
        // 文本框自动获得焦点
